...
project.description = 'Drop-in replacement for MinLog to log through SLF4j.'
project.group = 'com.dorkbox'
project.version = '1.12'

project.ext.name = 'MinLog-SLF4J'
project.ext.url = 'https://git.dorkbox.com/dorkbox/MinLog-SLF4J'
